...
function registerAppServices() {
    ...
    angular.module("VtigerOutlookAddon").factory('$crmapi', ["$deferred","$crmconnector","$localStorageService","$http",function($deferred,$crmconnector,$localStorageService,$http) {
        ...
        return {
            ...
            describe : function(module,fetchOutlookConfigurableFields=false,fetchSecondaryModuleName=false) {
                var params = {
                  '_operation' : 'describe',
            ...
            saveRecord : function(module,values,recordId,saveJointRecord=false) {
